...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("client-G.231.22.0017", "usm", "usmjaya001")) {
      Serial.println("Connected!");
      client.subscribe("g231220017/temperature");
      client.subscribe("g231220017/humidity");
      client.subscribe("g231220017/control");
    } else {
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == "g231220017/control") {
...
void publishTemp() {
  ...
  client.publish("g231220017/temperature", tempString, true);

  char humString[8];
  dtostrf(humidity, 1, 2, humString);
  client.publish("g231220017/humidity", humString, true);
}
